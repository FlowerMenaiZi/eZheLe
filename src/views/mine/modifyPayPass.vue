      ...
      <div class="rightContent">
        <div class="defaultShow">
          ...
          <div class="disf payPass">
            <div class="threeStep"><label>当前密码：</label><input type="password"></div>
            <div class="threeStep"><label>新密码：</label><input type="password" ref="password"></div>
            <div class="threeStep"><label>确认新密码：</label><input type="password" ref="repPassword"></div>
            <div>
              <button class="realAdd" @click="realModify">确认修改</button>
            </div>
          </div>
        </div>
      </div>
